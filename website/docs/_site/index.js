registerPaint(
  ...
  class {
    static get inputProperties() {
      return [
        '--constellations-particleColor',
        '--constellations-lineColor',
        '--constellations-particleAmount',
        '--constellations-defaultRadius',
        '--constellations-variantRadius',
        '--constellations-linkRadius'
      ]
    }
